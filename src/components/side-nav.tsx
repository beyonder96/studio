...
export function SideNav() {
  ...
  const NavButton = () => (
     <button
        ...
        className="bg-zinc-900/30 backdrop-blur-xl border border-white/10 shadow-2xl text-white p-4 rounded-[20px] transition-transform hover:scale-105 flex items-center justify-center"
